using MindVaultAI.Domain.Events;
using Microsoft.Extensions.Logging;

namespace MindVaultAI.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("MindVaultAI Domain Event: {DomainEvent}", notification.GetType().Name);
